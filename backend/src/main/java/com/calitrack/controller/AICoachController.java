...
public class AICoachController {
     ...
     * @param numWorkouts Number of recent completed workouts to analyze (default: 5)
     * @param userGoals User's fitness goals (e.g., "strength", "endurance", "hypertrophy")
     * @param fitnessLevel User's fitness level (e.g., "beginner", "intermediate", "advanced")
     * @param jwt The authenticated user's JWT token
     * @return AI-generated coaching recommendation
     */
    ...
    private CoachRecommendationRequest.WorkoutSummary buildWorkoutSummary(Workout workout) {
        ...
        ).stream().collect(Collectors.toMap(Exercise::getId, e -> e, (a, b) -> a));
